...
多くの場合ほとんどの実行環境でそのまま扱うことのできる32ビットまたは64ビットの基本形式が推奨されるが、どの形式で実数型を記述する(させる)かは策定者の自由である。


## <a id="sec-6"></a> 6. Recommendation for Encoder - エンコーダーへの勧告

### <a id="sec-6-1"></a> 6.1. Real Number Type - 実数型の扱い
