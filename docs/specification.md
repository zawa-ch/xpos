...
-	**Extended Identifier (拡張識別子)** --
	拡張データ型([3.3章](#sec-3-3))において、内容となる拡張データの種類を特定するための4バイトのビット列。
...
### <a id="sec-5-3"></a> 5.3. Name Rules - 名前の規則
...
### <a id="sec-5-4"></a> 5.4. Handling of Extended Object Type - 拡張オブジェクト型の扱い
...
### <a id="sec-5-5"></a> 5.5. Real Number Type - 実数型の扱い
